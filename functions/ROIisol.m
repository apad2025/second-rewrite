...
%ROIISOL Crop the data to a padded square ROI around the tissue mask.
%
%   data = ROIisol(data)
%
%   Trims Image / Mask / WeightedMagnitude to the bounding box of the mask
%   (made square and padded), updates data.Size, TrimmedIndices and flags.
%
