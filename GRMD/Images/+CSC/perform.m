    ...
    switch flags.method
        case {'IGC','MixedIGC'}
            D.CSCorrection = struct('Method', flags.method, ...
                        ...
                        'MaxGraphCutIterations', algoParams.MAX_ITERS, ...
        ...
        case 'BipolarIGC'
            D.CSCorrection = struct('Method', flags.method, ...
                            ...
                            'FieldMapRange', algoParams.range_fm, ...
                            'FieldMapNumbers', algoParams.NUM_FMS, ...
                            'R2StarRange', algoParams.range_r2star, ...
                            'R2StarNumbers', algoParams.NUM_R2STARS, ...
                            'GraphCuts', struct('MinIterations', algoParams.MIN_ITERS, ...
                                                'MaxIterations', algoParams.MAX_ITERS, ...
                                                'MaxStalledBipolarIterations', algoParams.MAX_STALLEDITERS_bipolar, ...
                                                'MaxStalledIterations', algoParams.MAX_STALLEDITERS, ...
                                                'Tolerance', algoParams.GCconvTol, ...
                                                'BipolarIterations', outParams.GCsteps_bipolar, ...
                                                'Iterations', outParams.GCsteps), ...
                            'OptimizationTransfer', struct('Descent', algoParams.DO_OT), ...
                            'Lambda', algoParams.lambda, ...
                            'LambdaMapPower', algoParams.LMAP_POWER, ...
                            'LambdaMapSmoothingFactor', algoParams.LMAP_EXTRA, ...
                            'TikhonovRegularization', algoParams.tik_reg, ...
                            'Seed', false);
            if algoParams.DO_OT
                D.CSCorrection.OptimizationTransfer.Tolerance = algoParams.OTconvTol;
                D.CSCorrection.OptimizationTransfer.Iterations = outParams.OTiters;
            end
            if isfield(algoParams,'seed') && ~isempty(algoParams.seed)
                D.CSCorrection.Seed = algoParams.seed;
            end
