classdef Hamiltonndb2011_FWspectrum < Custom_FWspectrum
    properties
    NDB=0;
    NMIDB=0;
    CL=0;
    ...
    methods
        function this = Hamiltonndb2011_FWspectrum(varargin)
        ...
        function amps=setFattyPeaks(this)
            ...
            switch this.UFV
                case 0
                    amps = [9, ((CL - 4) * 6) - (ndb * 8) + nmidb * 2, 6, (ndb - nmidb) * 4, 6, nmidb * 2, 4, 1, 2 * ndb];
                    amps = amps / sum(amps);
                ...
                case 1
                    ...
                    % F2 = -8B+4D+2J
                    amps = [[9, 6 * (CL - 4)+2*nmidb, 6, nmidb*-4, 6, nmidb * 2, 4, 1, 0];
                             [0,- 8, 0,4, 0,0, 0, 0, 2]];
